  ...
  var MentionsInput = function (input) {
    ...
    function updateValues() {
      ...
      _.each(mentionsCollection, function (mention) {
        var textSyntax = settings.templates.mentionItemSyntax({ value : mention.value, type : 'contact', id : mention.id, mention : mention });
      ...
      _.each(mentionsCollection, function (mention) {
        var textSyntax = settings.templates.mentionItemSyntax({ value : utils.htmlEncode(mention.value), type : 'contact', id : mention.id, mention : mention });
        var textHighlight = settings.templates.mentionItemHighlight({ value : utils.htmlEncode(mention.value), mention : mention });
